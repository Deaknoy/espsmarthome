...
{
  username: 'Deaknoy', // Username MQTT ของเรานะ
  password: 'Ge60apachepro', // Password MQTT ของเรานะ
  port: 12964 // Port MQTT ของเรานะ
});
...
const message = req.body.events[0].message.text;
  ...
  const TOKEN = `PEbrJ8GJqtTQOrO4DuSGrNQCt8PSU7ozE52X1/ltGDmPIBuh84rx61ZFUfzgwFXvIf7982AWL1otXYAXUF0t2oR4tQwTqp02QobwLNcH9wu2Qzv3lPGAyJc/9KFXIEziyzAA/vW+IauxYML/5rNPJgdB04t89/1O/w1cDnyilFU=`; // Token ที่ได้จาก Channel access token
  const HEADERS = {
